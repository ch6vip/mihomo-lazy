...
**本地面板（推荐）**：
- 地址：[http://127.0.0.1:9090/ui/](http://127.0.0.1:9090/ui/zashboard)
- 优点：无需联网，速度快，隐私性好
...
├── config.yaml             # 配置文件（需填写订阅链接）
├── 首次安装.bat            # 首次安装脚本（必须先运行）
├── start-mihomo.vbs        # 日常启动脚本（后台运行，自动清理旧进程）
├── 停止运行.bat            # 停止服务脚本
├── 重启.bat                # 重启服务脚本
├── 开启系统代理.bat        # 手动开启系统代理
├── 关闭系统代理.bat        # 手动关闭系统代理
...
### 本地面板（推荐）
- 访问地址：[http://127.0.0.1:9090/ui/](http://127.0.0.1:9090/ui/zashboard)
- 无需联网即可使用
- 速度快，隐私性好
...
4. 访问 [http://127.0.0.1:9090/ui](http://127.0.0.1:9090/ui/zashboard) 或在线面板
...
### Q: 如何访问本地面板？
A: 启动服务后，浏览器访问 [http://127.0.0.1:9090/ui/](http://127.0.0.1:9090/ui/zashboard)   ，即可。
...
### Q: 如何确认服务已启动？
A: 
1. 访问 [http://127.0.0.1:9090/ui/](http://127.0.0.1:9090/ui/zashboard)   ，能打开则服务正常
...
- 本地面板地址：[http://127.0.0.1:9090/ui/](http://127.0.0.1:9090/ui/zashboard)
